...
export const ROUTES: RouteInfo[] = [
    ...
    //
    // { path: '/about', title: 'Widgets', menuType: MenuType.LEFT, icon:'material-icons' },
    //
    // { path: '/services', title: 'Charts', menuType: MenuType.LEFT, icon:'material-icons' },
    //
    // { path: 'calendar', title: 'Calendar', menuType: MenuType.LEFT, icon:'material-icons' },
        ...
        {id: 2, icon: "bubble_chart", title: "About", path: "/about", menuType: MenuType.LEFT,},
        {id: 3, icon: "build", title: "Services", path: "/services", menuType: MenuType.LEFT,},
        {id: 4, icon: "import_contacts", title: "Contact", path: "/contact", menuType: MenuType.LEFT,}
